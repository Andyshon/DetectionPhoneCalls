...
public abstract class IncomingCall  extends BroadcastReceiver {
    ...
    public abstract void onIncomingCallReceived(Context ctx, String number, Date start);

    public abstract void onIncomingCallAnswered(Context ctx, String number, Date start);

    public abstract void onIncomingCallEnded(Context ctx, String number, Date start, Date end);

    public abstract void onOutgoingCallStarted(Context ctx, String number, Date start);
